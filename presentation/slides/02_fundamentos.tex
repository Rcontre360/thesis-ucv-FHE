...
\begin{frame}{Gestión de Ruido: Leveled vs. Bootstrapped}
    \begin{itemize}
        \item \textbf{Leveled FHE:} Esquemas diseñados para evaluar circuitos de una profundidad máxima $L$ predefinida. Utilizan una jerarquía de módulos para reducir el ruido tras las operaciones.
        \item \textbf{Bootstrapping:} Proceso de "refresco" del texto cifrado que reduce el nivel de ruido evaluando el propio circuito de descifrado homomórficamente. Permite profundidad de cómputo infinita.
    \end{itemize}
    \vfill
    \begin{figure}
        \centering
