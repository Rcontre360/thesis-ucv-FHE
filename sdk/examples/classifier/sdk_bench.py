...
Run from sdk/ root:
    python examples/bench-dev/sdk_bench.py
"""
import os, time
import numpy as np
...
print("=" * 55)
print("fhe_sdk GPU-CKKS Benchmark")
...
print(f"\n[2] Building fhe_sdk CKKS context...")
t0  = time.perf_counter()
ctx = (
    FHEContext()
...
# ---------------------------------------------------------------------------
# 3. Build FHE model (Square activation = x * x, costs 1 level)
# ---------------------------------------------------------------------------
