...
Dos construcciones fundacionales ilustran el enfoque asimétrico y se apoyan sobre dos problemas matemáticos clásicos: el protocolo de Diffie-Hellman, fundamentado en el problema del logaritmo discreto, y RSA, fundamentado en la factorización entera. Ambos se desarrollan a continuación.
